...
<div style="float:right; width:38%">
  <img alt="Algorithm" src="./assets/add_algorithm.png" style="height: 48%">
  <img alt="Memory" src="./assets/add.svg" style="height: 48%"/>
</div>
<img alt="Addition" src="./assets/addition.png" style="float: left; width: 48%"/>
