...
<div align="center">
  <img alt="Addition" src="./assets/addition.png" style="float: left; width: 40%; height: 100%; display: inline-block"/>
  <span align="top" style="float: right; width: 50%; height: 100%; display: inline-block">
    <img alt="Memory" align="top" src="./assets/add.svg" style="float: top; width: 30%; display: inline-block"/>
    <img alt="Algorithm" align="right" src="./assets/add_algorithm.png" style="float: top; width: 30%; display: inline-block"/>
  </span>
</div>
